...
/**
 * This is the main class where we play the rock paper scissors game with the
 * computer predicting based on previous patterns.
 * 
 * @author Jordan Lever
 *
 */
public class Main {
				...
				do {
					...
					if (select == 1) {
						...
						if (s.length() == 3) {
							...
							c.storePattern(s);
							s = p.getPattern().substring(1, p.getPattern().length() - 1);
							p = new Pattern(s);
							...
							if (user.equals(x)) {
								...
								if (user.equals("r") && x.equals("p")) {
									System.out.println("Computer Wins");
									computerS++;
									play(x, playerS, computerS, tieS);
								}
								if (user.equals("r") && x.equals("s")) {
									System.out.println("You Win");
									playerS++;
									play(x, playerS, computerS, tieS);
								}
								if (user.equals("s") && x.equals("p")) {
									System.out.println("You Win");
									playerS++;
									play(x, playerS, computerS, tieS);
								}
								if (user.equals("s") && x.equals("r")) {
									System.out.println("Computer Wins");
									computerS++;
									play(x, playerS, computerS, tieS);
								}
								if (user.equals("p") && x.equals("r")) {
									System.out.println("You Win");
									playerS++;
									play(x, playerS, computerS, tieS);
								}
								if (user.equals("p") && x.equals("s")) {
									System.out.println("Computer Wins");
									computerS++;
									play(x, playerS, computerS, tieS);
								}
	 ...
	 * @param c
	 *            the computer score counter
	 * @param t
	 *            the tie score counter
	 */
	public static void play(String x, int p, int c, int t) {
		System.out.println("Computer Played " + x);
		System.out.println("Player Score: " + p + " Comp Score: " + c + " Ties: " + t);
	}
	 ...
	 * 
	 * @param c
	 *            the computer object to write to teh .dat
	 */
	...
	/**
	 * This method reads the .dat file and makes a computer object based on the
	 * contents. It throws exceptions if there is no file or iuf the class could
	 * not be located.
	 * 
