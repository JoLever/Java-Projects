/**
 * This is the super class for person and abstract as we never make an  entity
 * It contains all of the methods for Entity and the constructor.
 * @author Jordan Lever
 *
 */
public abstract class Entity {
	 ...
	 * @param name1 	The name of the entity
	 * @param hp1		The health points of the entity
	 */
