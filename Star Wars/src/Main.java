...
/**
 * This class is the main where the arrays are created, their attacks cycled
 * through until the user completes their mission.
 * 
 * @author Jordan Lever
 *
 */
public class Main {
	...
	public static void main(String[] args) {
		...
		while (!finished) {
			...
			case 1:
				System.out
						.println("You and Your Team of Rebels Engage in Battle with the Sith Lord");
				...
				{
					rebel[0] = new Jedi(name,
							"I will bring balance to the force", color);
				...
				{
					empire[0] = new Stormtrooper("Stormtrooper 1",
							"Aim for the Plot Armor");
				...
				do {
					...
					if (userChoice == 3) {
						...
						rebel[7].doTask(rebel[healChoice]);
						System.out.println();
						printTeam(rebel, empire);
						cycle(rebel, empire);
						printTeam(rebel, empire);
			...
			case 2:
				...
				do {
					...
					if (userChoice == 3) {
						...
						if (rebel1[7].getHp() > 0) {
							rebel1[7].doTask(rebel1[healChoice]);
							printTeam2(rebel1, evil);
							cycle3(rebel1, evil);
							printTeam2(rebel1, evil);
							cycle4(evil, rebel1);
	...
	/**
	 * This method prints out the names of the Entities in the array and
	 * displays their hp
	 * 
	 * @param array
	 *            The array containing the information to print
	 */
	 ...
	 * 
	 * @param array
	 *            The array of the attacking team
	 * @param array1
	 *            the array containing the team being attacked
	 */
	 ...
	 * 
	 * @param rebel
	 *            the array for rebel team
	 * @param empire
	 *            the array for empire team
	 */
