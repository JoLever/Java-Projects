/**
 * This class contains the methods and constructor for the Jedi class. It
 * implements hasForce and Healable and is a subclass of Person.
 * 
 * @author Jordan Lever
 *
 */
public class Jedi extends Person implements HasForce, Healable {
	 ...
	 * @param quip1
	 *            The Catch Phrase of the Jedi
	 * @param sc1
	 *            The saber color of the Jedi
	 */
	...
	/**
	 * This is the overwritten method for attack. It generates a number from 0
	 * -20 and attacks the Entity and then says catch phrase if it is a
	 * successful attack
	 */
	@Override
	...
	/**
	 * The overwritten use force allows the jedi to do 20 dmg to a target and
	...
	public void useForce(Entity E) {
		...
		String nameX = getName();
		String enemyX = E.getName();
		System.out.println(nameX + " attacks  with the force for " + dmg
				+ " dmg to " + enemyX);
		sayCatchPhrase();
