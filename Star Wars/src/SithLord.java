/**
 * This class contains the constructor and methods for the Sithlord class It
 * implements Has force and is a subclass of Person
 * 
 * @author Jordan Lever
 *
 */
public class SithLord extends Person implements HasForce {
	 ...
	 * @param quip1
	 *            The catch phrase of the sith lord
	 * @param Sc1
	...
	/**
	 * This is overwritten attack method that generates a number form 0 to 20 if
	 * the attack is successful it prints the catch phrase
	 */
	@Override
	...
	/**
	 * The overwritten UseForce allows the sith lord to do 20 dmg to a target
