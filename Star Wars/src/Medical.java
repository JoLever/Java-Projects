/**
 * This class contains all of the methods and constructor for Medical class. It
 * is a subclass of Droid
 * 
 * @author Jordan Lever
 *
 */
public class Medical extends Droid {
	 ...
	 * 
	 * @param name1
	 *            the name of the medical droid
	 * @param hp
	 *            the health points of the droid
	 */
	...
	/**
	 * The doTask checks to see if the healing target is of instance rebel or
	 * jedi.
	 */
	@Override
	...
	private void heal(int hp) {
		...
		modifyHp(hp);
		System.out.println(x + " heals "  + " for  20 hp");
