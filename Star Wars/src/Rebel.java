/**
 * This class contains the constructor and methods for Rebel It also implements
 * Healable and is a subclass of Person
 * 
 * @author Jordan Lever
 *
 */
public class Rebel extends Person implements Healable {
	...
	/**
	 * The over written attack method generates a number from 1-10 if the attack
	 * is successful it hits the target and says catch phrase
	 */
	@Override
	...
	/**
	 * The doTask allows the rebel to use attack if the target is of instance
	 * person
	 */
	@Override
