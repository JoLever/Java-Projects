...
public class Jarjar extends Person implements HasForce {
	 ...
	 * 
	 * @param name1
	 *            The name of the Jarjar
	 * @param quip
	 *            The catch phrase of the Jarjar
	 */
	...
	/**
	 * The overwritten attack method allows for me to set the damage to be from
	 * 5 - 20, and then say catch phrase after an attack.
	 */
	@Override
	...
	/**
	 * The overwritten do task generates a number that corresponds to which
	 * attack Jarjar will use
	 */
	@Override
	...
	/**
	 * This method allows for JarJAR to do an AoE attack hitting all memebers of
	 * the rebel team
	 * 
	 * @param array
	 *            the array containing the rebel team to be damaged
	 */
